...
{
    [CustomPropertyDrawer(typeof(ComparisonOperator), true)]
    public class ComparisonOperatorDrawer : PropertyDrawer
    {
        ...
        private static void BuildTypeCache()
        {
            ...
            _typeCache = TypeCache.GetTypesDerivedFrom<ComparisonOperator>()
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var dropdown = new ComparisonOperatorDropdown(new AdvancedDropdownState(), (type) =>
                {
