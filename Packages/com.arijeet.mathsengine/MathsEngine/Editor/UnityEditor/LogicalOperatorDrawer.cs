...
using System.Linq;
using Baruah.MathsEngine.LogicalOperation;
using UnityEditor;
...
{
    [CustomPropertyDrawer(typeof(LogicalOperator), true)]
    public class LogicalOperatorDrawer : PropertyDrawer
    {
        ...
        private static void BuildTypeCache()
        {
            ...
            _typeCache = TypeCache.GetTypesDerivedFrom<LogicalOperator>()
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var dropdown = new LogicalOperatorDropdown(new AdvancedDropdownState(), (type) =>
                {
